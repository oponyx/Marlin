...
#define STRING_CONFIG_H_AUTHOR "(oponyx, A10M config)" // Who made the changes.
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  // A10M [@thinkyhead]
    ...
    #define DEFAULT_Kp_LIST {  55.29,  55.29 }
    #define DEFAULT_Ki_LIST {   6.37,   6.37 }
    #define DEFAULT_Kd_LIST { 120.03, 120.03 }
  #else
    #define DEFAULT_Kp  55.29
    #define DEFAULT_Ki   6.37
    #define DEFAULT_Kd 120.03
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 67.19   // 175.68 189.95
  #define DEFAULT_bedKi 8.82    //  34.59  37.40
  #define DEFAULT_bedKd 341.24   // 223.07 241.19
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 0, -2.8 }
